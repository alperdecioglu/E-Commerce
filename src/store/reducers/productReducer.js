import { SET_CATEGORIES, SET_PRODUCT_LIST, SET_TOTAL, SET_FETCH_STATE, SET_LIMIT, SET_OFFSET, SET_FILTER, SET_SORT, SET_ACTIVE_PRODUCT } from "../actions/actionTypes";
...
export const productReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_ACTIVE_PRODUCT: return { ...state, activeProduct: action.payload };
